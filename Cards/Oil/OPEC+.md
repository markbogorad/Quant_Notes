...
- Have an implicit [[Real Options]] to produce
- Helps control volatility, which is why U.S. allows them
- Technically a cartel and illegal in U.S.
- Control roughly 35% of production but most of sparce capacity
